...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b bg-[#1d4ED8]/10", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn( 
      "border-b transition-colors data-[state=selected]:bg-muted even:bg-white/90 hover:bg-[#1d4ED8]/10",
      className
    )}
    {...props}
  />
